...
const apiApplicationRouter = require('./api/application.router');
//Middleware's
...
//Rutas de CRUD de las aplicaciones.
router.use('/application', authJwt.verifyToken, apiApplicationRouter);
