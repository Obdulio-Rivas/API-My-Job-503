...
const userValidationRulesRegister = () => {
    return [
        ...
        check('age', 'La imagen del usuario es requerida!').not().isEmpty(),
        check('civilStatus', 'La imagen del usuario es requerida!').not().isEmpty(),
        check('numberDUI', 'La imagen del usuario es requerida!').not().isEmpty(),
        check('numberNIT', 'La imagen del usuario es requerida!').not().isEmpty(),
        ...
        check('birthDate', 'La imagen del usuario es requerida!').not().isEmpty(),        
        check('nationality', 'La imagen del usuario es requerida!').not().isEmpty(),
